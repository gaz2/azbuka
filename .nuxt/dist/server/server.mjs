import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, effectScope, reactive, version as version$1, unref, inject as inject$1, ref, watchEffect, watch, toRef, isRef, defineComponent as defineComponent$1, computed, h, resolveComponent, nextTick, shallowRef, shallowReactive, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, toRefs, capitalize, Fragment, warn, camelize, provide, createVNode, mergeProps, onScopeDispose, readonly, withAsyncContext, resolveDynamicComponent, useSSRContext, TransitionGroup, Transition, withDirectives, resolveDirective, vShow, withCtx, Suspense, toDisplayString, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrInterpolate, ssrRenderStyle, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/aboutme-971046cb.js").then((m) => m.default || m)
  },
  {
    name: "auth",
    path: "/auth",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/auth-1a16b62f.js").then((m) => m.default || m)
  },
  {
    name: "azbuka-chisel",
    path: "/azbuka-chisel",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/azbuka-chisel-932b66a2.js").then((m) => m.default || m)
  },
  {
    name: "cazino-vkusov",
    path: "/cazino-vkusov",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/cazino-vkusov-f46e33bd.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-e59220e1.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/karty-na-bochku-3e0aba72.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/podarochnaya-produkciya-292209ad.js").then((m) => m.default || m)
  },
  {
    name: "video",
    path: "/video",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/video-d9c300d6.js").then((m) => m.default || m)
  }
];
...
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-366b3d4f.js").then((r) => r.default));
  ...
  _push(ssrRenderComponent(VFooter, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<br${_scopeId}><span class="center-h2-white"${_scopeId}>${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())}</span></div>`);
      } else {
        return [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-aa514a13.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-93b9a998.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-1056528c.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export {
  ...
  deepEqual as C,
  findChildrenWithProvide as D,
  consoleWarn as E,
  wrapInArray as F,
  destructComputed as G,
  convertToUnit as H,
  IconValue as I,
  useIcon as J,
  useTextColor as K,
  flattenFragments as L,
  useResizeObserver as M,
  useRtl as N,
  useBackgroundColor as O,
  hasEvent as P,
  isObject as Q,
  keyCodes as R,
  SUPPORTS_INTERSECTION as S,
  makeDimensionProps as T,
  useDimension as U,
  VContainer as V,
  VDefaultsProvider as W,
  ...
  __nuxt_component_3 as g,
  getCurrentInstanceName as h,
  includes as i,
  useColor as j,
  makeComponentProps as k,
  makeElevationProps as l,
  makeBorderProps as m,
  makeRoundedProps as n,
  makeTagProps as o,
  propsFactory as p,
  makeThemeProps as q,
  genericComponent as r,
  provideTheme as s,
  useBorder as t,
  useHead as u,
  useElevation as v,
  useRounded as w,
  provideDefaults as x,
  useRender as y,
