...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/ufo/dist/index.mjs';
...
import { isAbsolute } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/pathe/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/gzdb/WebSitesProjects/azbuka/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _8oaP3WZ7Ep = (function(nitro) {
...
const _lazy_nwELg5 = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file:///home/gzdb/WebSitesProjects/azbuka/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/gzdb/WebSitesProjects/azbuka/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
