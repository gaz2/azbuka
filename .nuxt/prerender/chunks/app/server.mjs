import { version as version$1, ref, watchEffect, watch, getCurrentInstance as getCurrentInstance$1, defineAsyncComponent, Fragment, reactive, computed, toRefs, capitalize, warn, defineComponent as defineComponent$1, camelize, h, unref, provide, createVNode, mergeProps, inject as inject$1, toRaw, readonly, useSSRContext, shallowRef, nextTick, withDirectives, resolveDirective, isRef, toRef, Suspense, Transition, resolveComponent, onScopeDispose, withAsyncContext, resolveDynamicComponent, TransitionGroup, vShow, shallowReactive, createApp, effectScope, hasInjectionContext, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, withCtx, toDisplayString } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/unctx/dist/index.mjs';
import { defu } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/defu/dist/defu.mjs';
import { klona } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/klona/dist/index.mjs';
import { getActiveHead } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/@unhead/shared/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, appendHeader, sanitizeStatusCode } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, parseQuery, encodeParam, withTrailingSlash, withoutTrailingSlash, withLeadingSlash, joinURL, withQuery, isScriptProtocol, encodePath } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrInterpolate, ssrRenderSuspense, ssrRenderStyle } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/vue/server-renderer/index.mjs';
import { Icon as Icon$1 } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/@iconify/vue/dist/offline.mjs';
import { loadIcon } from 'file:///home/gzdb/WebSitesProjects/azbuka/node_modules/@iconify/vue/dist/iconify.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/aboutme-971046cb.mjs').then((m) => m.default || m)
  },
  {
    name: "auth",
    path: "/auth",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/auth-1a16b62f.mjs').then((m) => m.default || m)
  },
  {
    name: "azbuka-chisel",
    path: "/azbuka-chisel",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/azbuka-chisel-932b66a2.mjs').then((m) => m.default || m)
  },
  {
    name: "cazino-vkusov",
    path: "/cazino-vkusov",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/cazino-vkusov-f46e33bd.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-e59220e1.mjs').then((m) => m.default || m)
  },
  {
    name: "karty-na-bochku",
    path: "/karty-na-bochku",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/karty-na-bochku-3e0aba72.mjs').then((m) => m.default || m)
  },
  {
    name: "podarochnaya-produkciya",
    path: "/podarochnaya-produkciya",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/podarochnaya-produkciya-292209ad.mjs').then((m) => m.default || m)
  },
  {
    name: "video",
    path: "/video",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/video-d9c300d6.mjs').then((m) => m.default || m)
  }
];
...
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-366b3d4f.mjs').then((r) => r.default));
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file:///home/gzdb/WebSitesProjects/azbuka/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const ipxRuntime$cpnV8BkkHR = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$cpnV8BkkHR, defaults: {} }
};
const useImage = () => {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent$1({
  ...
  async setup(__props) {
    ...
    const iconName = computed(() => {
      var _a;
      return ((((_a = appConfig2.nuxtIcon) == null ? void 0 : _a.aliases) || {})[props.name] || props.name).replace(/^i-/, "");
    });
    const icon = computed(() => {
      var _a;
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-9c34c54e"]]);
...
function mounted(el, binding) {
  ...
  const observer = new IntersectionObserver(function() {
    ...
    if (!_observe)
      return;
    const isIntersecting = entries.some((entry2) => entry2.isIntersecting);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(VToolbarTitle, { style: { "margin": "10px" } }, {
              ...
              return [
                createVNode(VToolbarTitle, { style: { "margin": "10px" } }, {
                  default: withCtx(() => [
                    createVNode(_component_NuxtImg, {
                      format: "webp",
                      class: "white--text align-end",
        ...
        _push2(ssrRenderComponent(_component_Icon, {
          name: "mingcute:phone-fill",
          color: "black",
          width: "20",
          height: "20",
          onclick: "window.open('tel:+78129887430');",
          style: { "margin-right": "0px", "margin-top": "-5px" }
        }, null, _parent2, _scopeId));
        _push2(`<p onclick="window.open(&#39;tel:+78129887430&#39;);" style="${ssrRenderStyle({ "margin-right": "0px", "margin-top": "-5px", "font-size": "13px" })}"${_scopeId}>+7 812 988 74 30</p>`);
        _push2(ssrRenderComponent(VSpacer, null, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_Icon, {
          name: "logos:whatsapp-icon",
          width: "35",
          height: "35",
          onclick: "window.open('https://wa.me/79112549960/');",
        ...
        _push2(ssrRenderComponent(_component_Icon, {
          ...
          width: "30",
          height: "30",
          onclick: "window.open('https://t.me/OBREND78');",
          style: { "margin-right": "20px" }
        }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_Icon, {
          name: "cib:vk",
          ...
          height: "30",
          color: "#4D76A1",
          onclick: "window.open('https://vk.com/spb_acv');",
          style: { "margin-right": "20px" }
        }, null, _parent2, _scopeId));
      } else {
        return [
          ...
          createVNode("p", {
            onclick: "window.open('tel:+78129887430');",
            style: { "margin-right": "0px", "margin-top": "-5px", "font-size": "13px" }
          }, "+7 812 988 74 30"),
          createVNode(VSpacer),
          createVNode(_component_Icon, {
            name: "logos:whatsapp-icon",
  ...
  _push(ssrRenderComponent(VFooter, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
                        ...
                        if (_push5) {
                          _push5(ssrRenderComponent(_component_NuxtLink, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<h3 class="center-h2-white"${_scopeId5}>КАЗИНО ВКУСОВ</h3>`);
                              } else {
                                return [
                                  createVNode("h3", { class: "center-h2-white" }, "КАЗИНО ВКУСОВ")
                                ];
                              }
                            }),
                            _: 1
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(ssrRenderComponent(_component_NuxtLink, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<h3 class="center-h2-white"${_scopeId5}>АЗБУКА ЛОТО</h3>`);
                              } else {
                                return [
                                  createVNode("h3", { class: "center-h2-white" }, "АЗБУКА ЛОТО")
                                ];
                              }
                            }),
                            _: 1
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(ssrRenderComponent(_component_NuxtLink, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<h3 class="center-h2-white"${_scopeId5}>КАРТЫ НА БОЧКУ</h3>`);
                              } else {
                                return [
                                  createVNode("h3", { class: "center-h2-white" }, "КАРТЫ НА БОЧКУ")
                                ];
                              }
                            }),
                            _: 1
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(ssrRenderComponent(_component_NuxtLink, {
                            ...
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<h3 class="center-h2-white"${_scopeId5}>ВИДЕО</h3>`);
                              } else {
                                return [
                                  createVNode("h3", { class: "center-h2-white" }, "ВИДЕО")
                                ];
                              }
                            }),
                            _: 1
        ...
        _push2(`<div${_scopeId}>`);
        _push2(ssrRenderComponent(_component_NuxtLink, {
          to: "https://produce-site.ru",
          class: "center-h2-white"
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<strong${_scopeId2}>All Reserved.@produce-site.ru</strong>`);
            } else {
              return [
                createVNode("strong", null, "All Reserved.@produce-site.ru")
              ];
            }
          }),
          _: 1
        }, _parent2, _scopeId));
        _push2(`<br${_scopeId}><span class="center-h2-white"${_scopeId}>${ssrInterpolate(( new Date()).getFullYear())}</span></div>`);
      } else {
        return [
          ...
          createVNode("div", null, [
            ...
            createVNode("br"),
            createVNode("span", { class: "center-h2-white" }, toDisplayString((/* @__PURE__ */ new Date()).getFullYear()), 1)
          ])
        ];
      }
    }),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-aa514a13.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-93b9a998.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-1056528c.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { getUid as A, useProxiedModel as B, deepEqual as C, findChildrenWithProvide as D, consoleWarn as E, wrapInArray as F, destructComputed as G, convertToUnit as H, IconValue as I, useIcon as J, useTextColor as K, flattenFragments as L, useResizeObserver as M, useRtl as N, useBackgroundColor as O, hasEvent as P, isObject as Q, keyCodes as R, SUPPORTS_INTERSECTION as S, makeDimensionProps as T, useDimension as U, VContainer as V, VDefaultsProvider as W, createSimpleFunctional as X, VImg as Y, useAppConfig as Z, _export_sfc as _, __nuxt_component_0$2 as a, VRow as b, createError as c, VCol as d, entry$1 as default, __nuxt_component_0$1 as e, __nuxt_component_1 as f, __nuxt_component_3 as g, getCurrentInstanceName as h, includes as i, useColor as j, makeComponentProps as k, makeElevationProps as l, makeBorderProps as m, makeRoundedProps as n, makeTagProps as o, propsFactory as p, makeThemeProps as q, genericComponent as r, provideTheme as s, useBorder as t, useHead as u, useElevation as v, useRounded as w, provideDefaults as x, useRender as y, getCurrentInstance as z };
