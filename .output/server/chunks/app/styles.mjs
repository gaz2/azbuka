...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.22d5a050.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.5bb6fc8d.mjs').then(interopDefault),
  "pages/video.vue": () => import('./_nuxt/video-styles.7d3a9dbc.mjs').then(interopDefault),
